...
export function Lecturas({
  ...
  const calculateConsumption = (dept, type) => {
    ...
    const previousReading =
      type === 'water' ? dept.waterReading : dept.electricityReading
  ...
  const calculateAmount = (dept, type) => {
    ...
    const rate =
      type === 'water' ? settings.waterRate : settings.electricityRate
  ...
  const generateReceipt = (dept, type) => {
    ...
    setSelectedReceipt({
      ...
      rate: type === 'water' ? settings.waterRate : settings.electricityRate,
      amount,
    })
  }
                    ...
                    {filtered.map((dept) => (
                      ...
                      >
                        ...
                        <td className="p-4 text-foreground">
                          {calculateConsumption(dept, 'water')}
                        </td>
                  ...
                  <tbody>
                    {filtered.map((dept) => (
                      ...
                      >
                        ...
                        <td className="p-4 text-foreground">
                          {calculateConsumption(dept, 'electricity')}
                        </td>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Recibo de{' '}
              {selectedReceipt?.type === 'water' ? 'Agua' : 'Electricidad'}
            </DialogTitle>
          </DialogHeader>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <p className="font-medium text-foreground">
                      {selectedReceipt.tenant}
                    </p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">Departamento:</p>
                    <p className="font-medium text-foreground">
                      {selectedReceipt.department}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">
                      S/ {selectedReceipt.rate.toFixed(2)}/
                ...
                <div className="border-t border-border pt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-primary">
                      S/ {selectedReceipt.amount.toFixed(2)}
                    </span>
                  </div>
                </div>
              </div>
